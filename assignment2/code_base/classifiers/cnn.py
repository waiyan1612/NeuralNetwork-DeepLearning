...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    ############################################################################
    count = (int) (num_filters * input_dim[1] * input_dim[2] / 4)
    W1 = np.random.normal(loc=0, scale=weight_scale, size=(num_filters, input_dim[0], filter_size, filter_size))
    b1 = np.zeros(shape=(num_filters))
    W2 = np.random.normal(loc=0, scale=weight_scale, size=(count, hidden_dim))
